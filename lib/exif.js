// exif.js - Creador de stickers estilo Rock Lee 🍃
import fs from 'fs';
...
async function writeExifImg(media, metadata) {
  ...
  if (metadata.packname || metadata.author) {
    ...
    const json = { 
      'sticker-pack-id': 'https://github.com/RockLeeBot/RockLee-MD', 
      'sticker-pack-name': metadata.packname || 'Rock Lee Bot 🍃', 
      'sticker-pack-publisher': metadata.author || 'Rock Lee 🩻', 
